            ...
            <View>
                ...
                <View>
                    ...
                    <View style={{ justifyContent: 'flex-start', flexDirection: 'row', marginHorizontal: 5 }}>
                        <Text style={{ fontSize: 15, paddingLeft: 5, paddingTop: 2 }}>Cuota de servicio de migo</Text>
                    </View>
                </View>
                ...
                <View>
                    <View style={{ justifyContent: 'space-between', flexDirection: 'row', marginHorizontal: 5 }}>
                        <Text style={{ fontSize: 18, paddingLeft: 5, fontWeight: 'bold' }}>23:59:00</Text>
                        <Text style={{ fontSize: 15, paddingLeft: 5, marginTop: 10, fontWeight: 'bold' }}>-$15.00 MXN</Text>
                    </View>
                    <View style={{ justifyContent: 'flex-start', flexDirection: 'row', marginHorizontal: 5 }}>
                        <Text style={{ fontSize: 15, paddingLeft: 5, paddingTop: 2 }}>Cuota de servicio de migo</Text>
                    </View>
                ...
                <View>
                    <View style={{ justifyContent: 'space-between', flexDirection: 'row', marginHorizontal: 5 }}>
                        <Text style={{ fontSize: 18, paddingLeft: 5, fontWeight: 'bold' }}>23:59:00</Text>
                        <Text style={{ fontSize: 15, paddingLeft: 5, marginTop: 10, fontWeight: 'bold' }}>$120.00 MXN</Text>
                    </View>
                    <View style={{ justifyContent: 'flex-start', flexDirection: 'row', marginHorizontal: 5 }}>
                        <Text style={{ fontSize: 15, paddingLeft: 5, paddingTop: 2 }}>Cuota de servicio de migo</Text>
                    </View>
                ...
                <View>
                    <View style={{ justifyContent: 'space-between', flexDirection: 'row', marginHorizontal: 5 }}>
                        <Text style={{ fontSize: 18, paddingLeft: 5, fontWeight: 'bold' }}>23:00:00</Text>
                        <Text style={{ fontSize: 15, paddingLeft: 5, marginTop: 10, fontWeight: 'bold' }}>$50.00 MXN</Text>
                    </View>
                    <View style={{ justifyContent: 'flex-start', flexDirection: 'row', marginHorizontal: 5 }}>
                        <Text style={{ fontSize: 15, paddingLeft: 5, paddingTop: 2 }}>Cuota de servicio de migo</Text>
                    </View>
                ...
                <View>
                    <View style={{ justifyContent: 'space-between', flexDirection: 'row', marginHorizontal: 5 }}>
                        <Text style={{ fontSize: 18, paddingLeft: 5, fontWeight: 'bold' }}>23:00:00</Text>
                        <Text style={{ fontSize: 15, paddingLeft: 5, marginTop: 10, fontWeight: 'bold' }}>$100.00 MXN</Text>
                    </View>
                    <View style={{ justifyContent: 'flex-start', flexDirection: 'row', marginHorizontal: 5 }}>
